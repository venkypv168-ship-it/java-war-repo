    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh 'scp -i /home/ec2-user/testkey.pem /home/ec2-user/workspace/tomcat/target/hello-1.0.war ubuntu@35.175.203.210:/home/ubuntu/apache-tomcat-9.0.109/webapps'
